...
<script>
	function LOGIN(e) {
		...
		alert("Sucess1");
		var uregex = /[0-9a-zA-Z]{3,}/;
		var pregex = /[0-9a-zA-Z]{3,}/;
		...
		if (pass.match(pregex) && uname.match(uregex)) {
			...
			request.onreadystatechange = function() {
				...
				if (request.readyState == 4) {
					...
					if (value == "Admin") {
						/*alert("admin");*/ 
						window.location.href = "jspHtmlCssJS/AdminLoginPage.jsp";
					} else if (value == "Doctor") {
						//alert("doctor");
						window.location.href = "jspHtmlCssJS/DoctorLoginPage.jsp"
					} else if (value == "Staff") {
						//alert("Staff")
						window.location.href = "jspHtmlCssJS/StaffLoginPage.jsp"
					}
